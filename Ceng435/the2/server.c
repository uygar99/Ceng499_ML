...
int len=sizeof(cliaddr); // length of the server address
...
//                sendto(sockfd, (struct Message *)&messages[next_seq_num], sizeof(messages[next_seq_num]),0,(const struct sockaddr *) &cliaddr,sizeof(cliaddr));
//                next_seq_num++;
//            }
//            if(ACKs[k] == 1) {
//                break;
...
//        }
//        for(int i=0; i < k; i++) {
//            sendto(sockfd, (struct Message *)&messages[i], sizeof(messages[i]),0,(const struct sockaddr *) &cliaddr,sizeof(cliaddr));
//        }
...
//        n = recvfrom(sockfd, (struct Message *)&received_message, sizeof(received_message),0,( struct sockaddr *) &cliaddr, &len);
...
//                sendto(sockfd, (struct Message *)&ACK, sizeof(ACK),0,(const struct sockaddr *) &cliaddr,sizeof(cliaddr));
//            }
//        }
...
int main() {
    ...
    memset(&cliaddr, 0, sizeof(cliaddr)); //making server address 0
